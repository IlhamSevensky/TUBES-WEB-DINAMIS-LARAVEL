      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                // Mengambil semua data dari tabel details yang digabung dengan tabel product dimana ID di tabel product sama dengan PRODUCT_ID di tabel details ;
                $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN products ON products.id=details.product_id");
                $stmt->execute();

                $total = 0;
                foreach($stmt as $srow){
                  // perulangan data (total harga product dikali quantity lalu ditambah lagi dengan total harga perulangan selanjutnya )
                  $subtotal = $srow['price']*$srow['quantity'];
                  $total += $subtotal;
                }
                // Tampilkan jumlah total uang dari semua transaksi
                echo "<h3>Rp. ".number_format($total)."</h3>";
              ?>
              <p>Total Sales</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                // mengambil semua jumlah kolom dari tabel product dan nilainya disimpan sebagai numrows
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM products");
                $stmt->execute();
                $prow =  $stmt->fetch();
                // Tampilkan jumlah product
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
              // Mengambil semua data dari tabel details, tabel sales, dan tabel product dimana ID di tabel sales sama dengan SALES_ID di tabel details serta ID di tabel product sama dengan PRODUCT_ID di tabel details yang hari ini saja
